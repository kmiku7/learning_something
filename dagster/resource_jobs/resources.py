...
class LocalSQLiteWarehouse:
    ...
    # In practice, you'll probably want to write more generic,
    # reusable logic on your resources than this tutorial example
    def update_normalized_cereals(self, records):
        ...
        try:
            ...
            curs.execute("""CREATE TABLE IF NOT EXISTS normalized_cereals
